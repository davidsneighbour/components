...
If you are using the [Robots component of DNB Hugo](https://github.com/dnb-hugo/components/tree/main/robots), then your resulting `robots.txt` will have a pointer to the sitemap file as well.
